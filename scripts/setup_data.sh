...
echo "  python -m pipe_sql.validation.run --data $DATA_DIR/dev.json --db-dir $DATA_DIR/database --source spider --baseline"
echo ""
echo "For BIRD data, also run: bash scripts/setup_bird_data.sh"
