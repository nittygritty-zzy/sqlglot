...
echo "  python -m pipe_sql.training.generate \\"
echo "      --golden-pairs pipe_sql/validation_output/golden_pairs_consolidated.jsonl \\"
echo "      --db-dir data/spider/database \\"
echo "      --db-dir $TRAIN_DB_DIR \\"
echo "      --db-dir $DEV_DIR/dev_databases \\"
echo "      --output-dir pipe_sql/training_output"
